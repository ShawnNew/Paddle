...
class TestMLUIndexSelect(OpTest):
...
# class TestMLUIndexSelectCase2(TestMLUIndexSelect):
...
class TestMLUIndexSelectCase3(TestMLUIndexSelect):
...
# class TestMLUIndexSelectCase4(TestMLUIndexSelect):
...
class TestMLUIndexSelectAPI(unittest.TestCase):
    ...
    def test_index_select_api(self):
        ...
        with program_guard(Program(), Program()):
            ...
            exe = paddle.static.Executor(paddle.MLUPlace(0))
            res, = exe.run(feed={
                'x': self.data_x,
